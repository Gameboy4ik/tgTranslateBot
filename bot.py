...
def translating(message):
    ...
    if not language_set:  # if false user must choose the language the bot will translate into
        while not language_set:
            ...
            if message.text == '🇷🇺 RU':
                ...
                if config.interface == 'english':
                    bot.send_message(message.chat.id, 'Select new language please',
                                     reply_markup=config.eng_different_lang_buttons1)
                elif config.interface == 'russian':
                    bot.send_message(message.chat.id, 'Выберите новый язык пожалуйста',
                                     reply_markup=config.rus_different_lang_buttons1)
                elif config.interface == 'ukrainian':
                    bot.send_message(message.chat.id, 'Виберіть нову мову будь ласка',
                                     reply_markup=config.ukr_different_lang_buttons1)
                language_set = True
                ...
                for key, msg in languages_keyboard.ENG_LANGUAGES.items():
                    if msg == message.text.lower() or key == message.text.lower() and language_set is False:
                        ...
                        if config.interface == 'russian':
                            bot.send_message(message.chat.id,
                                             f'<b>{languages_keyboard.RUS_LANGUAGES[key].title()}</b> установлен.',
                                             parse_mode='html', reply_markup=config.rus_menu)
                        elif config.interface == 'english':
                            ...
                            bot.send_message(message.chat.id,
                                             f'<b>{languages_keyboard.UKR_LANGUAGES[key].title()}</b> встановлена.',
                                             parse_mode='html', reply_markup=config.ukr_menu)
                        language_set = True
                        break
                ...
                for key, msg in languages_keyboard.RUS_LANGUAGES.items():  # like ENG
                    if msg == message.text.lower() or key == message.text.lower() and language_set is False:
                        ...
                        language_set = True
                        break
                if language_set is False and reset_language is True:  # if message not in dictionary, while restart
                    if config.interface == 'russian':
            ...
            if config.first_language == 'auto':
                bot.send_message(message.chat.id,
                                 (translator.translate(message.text,
                                                       languages_keyboard.ENG_LANGUAGES[config.second_language])).text)
            else:
                bot.send_message(message.chat.id,
                                 (translator.translate(message.text,
                                                       languages_keyboard.ENG_LANGUAGES[config.second_language],
                                                       languages_keyboard.ENG_LANGUAGES[config.first_language])).text)


@bot.message_handler(commands=['start'])
def welcome(message):  # welcome to function
...
def callback_inline(call):
    ...
    if call.message:
        if call.data == 'switch_second':
            ...
            if config.interface == 'english':
                if config.first_language == 'auto':
                    bot.edit_message_text(
                        f'First: <b>Auto</b>\nSecond: '
                        f'{languages_keyboard.ENG_LANGUAGES[config.second_language].title()}',
                        call.message.chat.id, call.message.message_id, parse_mode='html')
                else:
                    bot.edit_message_text(
                        f'First: <b>{languages_keyboard.ENG_LANGUAGES[config.first_language].title()}</b>\nSecond: <b>'
                        f'{languages_keyboard.ENG_LANGUAGES[config.second_language].title()}</b>',
                        call.message.chat.id, call.message.message_id, parse_mode='html')
                bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                              reply_markup=config.eng_both_languages)
            elif config.interface == 'russian':
                if config.first_language == 'auto':
                    bot.edit_message_text(
                        f'Первый: <b>Авто</b>\nВторой: <b>'
                        f'{languages_keyboard.RUS_LANGUAGES[config.second_language].title()}</b>',
                        call.message.chat.id, call.message.message_id, parse_mode='html')
                else:
                    bot.edit_message_text(
                        f'Первый: <b>{languages_keyboard.RUS_LANGUAGES[config.first_language].title()}</b>\nВторой: <b>'
                        f'{languages_keyboard.RUS_LANGUAGES[config.second_language].title()}</b>',
                        call.message.chat.id, call.message.message_id, parse_mode='html')
                bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                              reply_markup=config.rus_both_languages)
            elif config.interface == 'ukrainian':
                if config.first_language == 'auto':
                    bot.edit_message_text(
                        f'Перший: <b>Авто</b>\nДругий: <b>'
                        f'{languages_keyboard.UKR_LANGUAGES[config.second_language].title()}</b>',
                        call.message.chat.id, call.message.message_id, parse_mode='html')
                else:
                    bot.edit_message_text(
                        f'Перший: <b>{languages_keyboard.UKR_LANGUAGES[config.first_language].title()}</b>\nДругий: <b>'
                        f'{languages_keyboard.UKR_LANGUAGES[config.second_language].title()}</b>',
                        call.message.chat.id, call.message.message_id, parse_mode='html')
                bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                              reply_markup=config.ukr_both_languages)
            ...
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.eng_different_lang_buttons2)
        elif call.data == 'eng_next2':
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.eng_different_lang_buttons3)
        elif call.data == 'eng_next3':
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.eng_different_lang_buttons4)
            ...
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.rus_different_lang_buttons2)
        elif call.data == 'rus_next2':
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.rus_different_lang_buttons3)
        elif call.data == 'rus_next3':
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.rus_different_lang_buttons4)
            ...
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.ukr_different_lang_buttons2)
        elif call.data == 'ukr_next2':
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.ukr_different_lang_buttons3)
        elif call.data == 'ukr_next3':
            bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id,
                                          reply_markup=config.ukr_different_lang_buttons4)
            ...
            if config.interface == 'english':
                if config.first_language == 'auto':
                    bot.send_message(call.message.chat.id,
                                     f'Translation <b>Auto - '
                                     f'{languages_keyboard.ENG_LANGUAGES[config.second_language].title()}</b> set.',
                                     parse_mode='html', reply_markup=config.eng_menu)
                else:
                    bot.send_message(call.message.chat.id,
                                     f'Translation <b>{languages_keyboard.ENG_LANGUAGES[config.first_language].title()}'
                                     f' - {languages_keyboard.ENG_LANGUAGES[config.second_language].title()}</b> set.',
                                     parse_mode='html', reply_markup=config.eng_menu)
            elif config.interface == 'russian':
                if config.first_language == 'auto':
                    bot.send_message(call.message.chat.id,
                                     f'Перевод <b>Авто - '
                                     f'{languages_keyboard.RUS_LANGUAGES[config.second_language].title()}'
                                     f'</b> установлен.',
                                     parse_mode='html', reply_markup=config.rus_menu)
                else:
                    bot.send_message(call.message.chat.id,
                                     f'Перевод <b>{languages_keyboard.RUS_LANGUAGES[config.first_language].title()} - '
                                     f'{languages_keyboard.RUS_LANGUAGES[config.second_language].title()}'
                                     f'</b> установлен.',
                                     parse_mode='html', reply_markup=config.rus_menu)
            elif config.interface == 'ukrainian':
                if config.first_language == 'auto':
                    bot.send_message(call.message.chat.id,
                                     f'Переклад <b>Авто - '
                                     f'{languages_keyboard.UKR_LANGUAGES[config.second_language].title()}'
                                     f'</b> встановлен.',
                                     parse_mode='html', reply_markup=config.ukr_menu)
                else:
                    bot.send_message(call.message.chat.id,
                                     f'Переклад <b>{languages_keyboard.UKR_LANGUAGES[config.first_language].title()} - '
                                     f'{languages_keyboard.UKR_LANGUAGES[config.second_language].title()}'
                                     f'</b> встановлен.',
                                     parse_mode='html', reply_markup=config.ukr_menu)
